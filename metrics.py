...
class WeightBasedFirstVolleyMetric:
    ...
    def calculate_weight_based_first_volley_metric(self, robot_stats_list: list, total_score: int):
        scouted_shots = {}
        capacities = {}
        uncapped = []
        final_scores = {}
...
class FirstVolleyBPSWeightedAccuracyTournament:
    def __init__(self, all_robots):
        self.final_scores = {}
    ...
    def calculate_first_volley_bps_weighted_accuracy_tournament(self, robot_stats_list: list, total_score: int):
        bps_weighted_accuracy = {}
        uncapped = []
        final_scores = {}

        for robot_stats in robot_stats_list:
            if robot_stats["name"] not in self.tournament_stats:
                first_volley = robot_stats["stats_per_volley"][0]
                ...
                self.tournament_stats[robot_stats["name"]] = {"bps": bps, "accuracy": accuracy}

            cached = self.tournament_stats[robot_stats["name"]]
            bps = cached["bps"]
